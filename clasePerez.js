...
// OBJETO CONSTRUCTOR
function bebida (producto, valor, stock){
...
var vino = new bebida ('vino', 500, 20);
var cerveza = new bebida ('cerveza', 300, 10);
var coca = new bebida ('coca-cola', 200, 30);
var jugo = new bebida ('jugo de naranja', 100, 50);
var precioEnvio = 200;
var total = 0;
...
function pedido2 (compra){
    ...
    if (compra == 'vino' && vino.cantidad > 0){
        ...
        console.log ('su compra es ' + vino.producto + ', se le agrego a su total $' + vino.valor + ' y quedan en stock ' + vino.cantidad);
        ...
        console.log ('su compra es ' + cerveza.producto + ', se le agrego a su total $' + cerveza.valor + ' y quedan en stock ' + cerveza.cantidad);
        console.log ('Su total es de $' + total)
        ...
        console.log ('su compra es ' + coca.producto + ', se le agrego a su total $' + coca.valor + ' y quedan en stock ' + coca.cantidad);
        console.log ('Su total es de $' + total)

    }else if (compra == 'jugo' && jugo.cantidad > 0){

        jugo.cantidad = jugo.cantidad - 1;
        total = total + jugo.valor;
        console.log ('su compra es ' + jugo.producto + ', se le agrego a su total $' + jugo.valor + ' y quedan en stock ' + jugo.cantidad);
        console.log ('Su total es de $' + total)
